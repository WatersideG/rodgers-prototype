...
def buyers_guide():
    ...
    h += (f'<section><div class="wrap"><p class="note">Guidance paraphrased from evo, REI, Powder7, Switchback Travel, Tactics and The Ski Monster buying guides, brand fit pages, Bootfitters.com, Wayfinder, SkiTalk, US Ski &amp; Snowboard equipment rules and The Pro Ski &amp; Ride junior racing guide, as of September 2026. This page is a Payload collection (type, sections, examples) so the shop can update it without a developer.</p></div></section>')
